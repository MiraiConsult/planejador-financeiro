    ...
    return (
      <input
        ...
        className={cn(
          ...
          'dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus-visible:ring-brand-400 dark:focus-visible:border-brand-400',
          className,
        )}
        {...props}
      />
